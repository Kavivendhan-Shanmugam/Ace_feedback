...
const BatchManager: React.FC = () => {
  ...
  const handleUpdateBatch = async (values: { name: string }) => {
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end items-center space-x-2">
                      ...
                      <ConfirmAlertDialog
                        ...
                        description="This will permanently delete the batch. All associated subjects and timetable entries will also be deleted. Student profiles will have their batch unassigned."
